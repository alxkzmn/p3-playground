...
use p3_hyperplonk::evm_codec::{
    ...
    count_merkle_digests_in_proof, encode_calldata_verify_bytes, encode_proof_blob_v3,
    hex_prefixed, render_json_payload_with_metrics_and_merkle,
};
...
use p3_whir::{
    FoldingFactor, ProtocolParameters, SecurityAssumption,
...
fn run() -> Result<(), String> {
    ...
    let config = {
        ...
        let whir_params = ProtocolParameters {
            ...
            merkle_hash: FieldHash::for_security_bits(merkle_security_bits),
            merkle_compress: Compress::for_security_bits(merkle_security_bits),
